...
('Théâtre : "Le Songe d''une Nuit d''Été"', 'Une adaptation contemporaine et magique de la célèbre pièce de Shakespeare. Mise en scène par la troupe "Les Illuminés".', '18€ tarif plein, 12€ tarif réduit', '2025-09-05 20:30:00', NULL, 2, 0, 2), -- Non publié, créé par admin.concerts
('Conférence : "L''Avenir de l''Art Numérique"', 'Animée par Dr. Pixel, pionnier de l''art génératif. Quelles sont les prochaines révolutions créatives ?', 'Gratuit sur réservation', '2025-06-28 18:30:00', NULL, 4, 1, 1), -- Créé par superadmin@lachaudiere.fr (supposé ID 1)
